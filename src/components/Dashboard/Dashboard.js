...
const Dashboard = () => {
  ...
  const { sellerToken, sellerData, handleLogout } = useOutletContext();
      ...
      <div className="seller-dashboard">
        <header className="dashboard-header">
          ...
          <div className="header-right">
            ...
            <div className="user-menu" role='button' onClick={() => navigate('/seller/profile')}>
        ...
        <div className="dashboard-content">
          ...
          <div className="action-buttons-section">
            <button
              ...
              onClick={() => navigate('/seller/create-brand')}
            >
              <FaTag /> Create Brand
            </button>
            <button
